...
public class ImageBase {
	...
	buttons[counter++] =new SimpleButton("Flip Horizontal", new FlipHorizontal());
	
	buttons[counter++]=new SimpleButton("Blurr",new Blurr());
	...
	buttons[counter++] = new SimpleButton("Negetive", new Negetive());
	...
	buttons[counter++]= new SimpleButton("Scroll Vertical", new ScrollVertical());
	buttons[counter++]= new SimpleButton("Save", new Save(),Color.PINK);
    ...
    class Save implements ActionListener {
    	public void actionPerformed (ActionEvent e) {
    		 File file = new File("editedIimage.jpg");
    		try{
    	  ImageIO.write(picture.bufferedImage,"jpg",file);
    ...
    class Negetive implements ActionListener {
	public void actionPerformed (ActionEvent e) {
   ...
   class GreyScale implements ActionListener{
    ...
    class ScrollVertical implements ActionListener {
        public void actionPerformed (ActionEvent e) {

            int imageWidth = picture.getWidth();
            int imageHeight = picture.getHeight();
            Pixel pix1, pix2;
            Pixel pixelArray[][] = new Pixel [imageWidth][40];
            for (int x= 0; x< 40; x++) {
            for (int y = 0; y < imageWidth; y++) {
                pix1 = picture.getPixel(y, x);
                pixelArray[y][x]=pix1;
            }
           }
           for(int x=40;x<imageHeight;x++){
                for(int y=0;y<imageWidth;y++){
                    pix1 = picture.getPixel(y, x);
                    picture.setPixel(y , x-40, pix1);
                }
            }
           int k=0;
           for(int x=imageHeight-40;x<imageHeight;x++){
               for(int y= 0;y< imageWidth;y++){
                   picture.setPixel(y,x,pixelArray[y][k]);
               }
               k++;
           }
            pictureFrame.refresh(picture);
